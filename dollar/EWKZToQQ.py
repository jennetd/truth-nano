...
options.register('gridpack',  'ewkzjjjj_5f_LO_dsign_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz',  VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack?")
